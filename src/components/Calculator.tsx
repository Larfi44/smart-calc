...
export const Calculator: React.FC<CalculatorProps> = ({
  ...
  const formatProgrammerDisplay = (expr: string): React.ReactNode[] => {
    const parts = expr.split(/(\s*[+\-×÷]\s*|\s+(AND|OR|XOR|mod)\s+)/);
    return parts.map((part, i) => {
      const trimmed = part.trim();
      if (!trimmed || /^[+\-×÷]$/.test(trimmed) || /^(AND|OR|XOR|mod)$/.test(trimmed)) {
    ...
    <div className="calculator-mode">
      ...
      <div className="calculator-display">
        ...
        <div className="display-value">
          {calcType === 'programmer' ? formatProgrammerDisplay(display) : display}
      ...
      <div className="calculator-buttons">
        {calcType === 'scientific' && (
          <>
            ...
            <div className="function-row">
              ...
              <button className="func-btn" onClick={() => handleFunction('tg')}>tg</button>
              <button className="func-btn" onClick={() => handleFunction('ctg')}>ctg</button>
            ...
            <div className="function-row">
              ...
              <button className="func-btn" onClick={() => handleFunction('atg')}>atg</button>
              <button className="func-btn" onClick={() => handleFunction('actg')}>actg</button>
              <button className="func-btn" onClick={() => handleFunction('pi')}>π</button>
            </div>
            <div className="function-row">
              <button className="func-btn" onClick={() => handleFunction('e')}>e</button>
              <button className="func-btn" onClick={() => handleFunction('fact')}>x!</button>
              ...
              <button className="func-btn" onClick={() => handleOperator('mod')}>mod</button>
            </div>
          </>
        )}
        ...
        {calcType === 'normal' && (
          <div className="function-row">
            ...
            <button className="func-btn" onClick={() => handleFunction('pi')}>π</button>
            <button className="func-btn" onClick={() => handleFunction('e')}>e</button>
            <button className="func-btn" onClick={() => handleFunction('round')}>rnd</button>
          </div>
        )}
