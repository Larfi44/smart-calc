...
export const Calculator: React.FC<CalculatorProps> = ({
  ...
  return (
    <div className="calculator-mode">
      ...
      {calcType === 'programmer' && (
        <div className="calc-type-selector">
          <button className={`calc-type-btn ${numberBase === 'dec' ? 'active' : ''}`} onClick={() => setNumberBase('dec')}>{t.decimal}</button>
          <button className={`calc-type-btn ${numberBase === 'bin' ? 'active' : ''}`} onClick={() => setNumberBase('bin')}>{t.binary}</button>
          <button className={`calc-type-btn ${numberBase === 'oct' ? 'active' : ''}`} onClick={() => setNumberBase('oct')}>{t.octal}</button>
          <button className={`calc-type-btn ${numberBase === 'hex' ? 'active' : ''}`} onClick={() => setNumberBase('hex')}>{t.hexadecimal}</button>
        </div>
      )}
      ...
      <div className="calculator-buttons">
        {calcType === 'scientific' && (
          <>
            ...
            <div className="function-row">
              ...
              <button className="func-btn" onClick={() => handleFunction('percentOf')}>% от</button>
              <button className="func-btn" onClick={() => handleFunction('exp')}>eˣ</button>
        ...
        {calcType === 'programmer' && (
          <>
            <div className="function-row">
              <button className="func-btn" onClick={() => handleFunction('xor')}>XOR</button>
              <button className="func-btn" onClick={() => handleFunction('and')}>AND</button>
              <button className="func-btn" onClick={() => handleFunction('or')}>OR</button>
            ...
            <div className="function-row">
              ...
              <button className="func-btn" onClick={() => setNumberBase('dec')}>DEC</button>
              <button className="func-btn" onClick={() => setNumberBase('bin')}>BIN</button>
              <button className="func-btn" onClick={() => setNumberBase('oct')}>OCT</button>
              <button className="func-btn" onClick={() => setNumberBase('hex')}>HEX</button>
            </div>
          </>
        )}
        ...
        {calcType === 'normal' && (
          <div className="function-row">
            <button className="func-btn" onClick={() => handleFunction('sqrt')}>√</button>
            <button className="func-btn" onClick={() => handleFunction('square')}>x²</button>
            <button className="func-btn" onClick={() => handleFunction('percent')}>%</button>
            <button className="func-btn" onClick={() => handleFunction('abs')}>|x|</button>
            <button className="func-btn" onClick={() => handleFunction('fact')}>n!</button>
          </div>
        )}
        ...
        <div className="button-row">
          ...
          <button className="btn btn-percent" onClick={() => handleFunction('percent')}>%</button>
